...
local inventoryRemote = ReplicatedStorage.Remotes:FindFirstChild("InventoryEvent")
local cashRemote = ReplicatedStorage.Remotes:FindFirstChild("CashEvent")
...
function PlrDataManager:GiveTools(plr:Player)
	...
	for i , v  in ipairs(self[plr.UserId].ToolsBought) do
		...
		local StarterGear_Clone = ReplicatedStorage.AxesFolder:FindFirstChild(v):Clone()
		local Backpack_Clone = ReplicatedStorage.AxesFolder:FindFirstChild(v):Clone()
